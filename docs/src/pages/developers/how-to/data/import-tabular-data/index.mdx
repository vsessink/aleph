...
Below is a simple mapping file. It downloads a list of British members of parliament and transforms them into `Person` entities. Please refer to the [FollowTheMoney documentation](fixme) for detailed instructions on how to write a mapping file and more complex examples.
