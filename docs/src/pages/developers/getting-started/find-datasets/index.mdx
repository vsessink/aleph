...
The datasets listed below can be downloaded in or easily converted to the FollowTheMoney format. Please refer to our guide on [importing FollowTheMoney data](/developers/how-to/data/import-data) for detailed instructions on how to import these datasets into your Aleph instance.
